...
public class MainFrame
    ...
    ModelDraw myDrawModel = new ModelDraw();
    DrawingPanel myDrawingPanel = new DrawingPanel(myDrawModel);
    ...
    public MainFrame() {
        ...
        try {
            jbInit();
            //ajout des differentes vues
            myDrawModel.addView(myDrawingPanel);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
